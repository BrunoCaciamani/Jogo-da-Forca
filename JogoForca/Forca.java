...
public class Forca extends JFrame{
	...
	private void startGame(){
		String[] palavras = {"brasil", "chile", "argentina", "paraguai", "uruguai", "peru", "venezuela", 
		"suriname", "colombia", "equador", "mexico", "estados unidos", "canada", "frança", "holanda",
		"alemanha", "russia", "belgica", "india", "china", "indonesia", "australia", "espanha"
		"italia", "marrocos", "egito", "senegal", "gana"};
